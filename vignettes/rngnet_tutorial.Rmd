...
```{r run_model_1}
fit <- run_SRM(stripey, bg = Oz, env = bioclim_rast, validation_type = "folds", validation_folds = 5L, early_stop_patience = 12)
```
...
bioclim_proj_50_vx <- velox::velox(bioclim_proj_50)

bioclim_proj_50_vx$crop(Oz)

bioclim_proj_50_rast <- bioclim_proj_50_vx$as.RasterStack()

bioclim_proj_70_vx <- velox::velox(bioclim_proj_70)

bioclim_proj_70_vx$crop(Oz)

bioclim_proj_70_rast <- bioclim_proj_70_vx$as.RasterStack()
